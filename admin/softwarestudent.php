...
<div class="container">
    ...
    <div class="col-12 col-lg-9 col-md-9 col-sm-12 mb-3">
                ...
                $sql = "SELECT * FROM student where class = '7' ";
               ...
               ?>
                 ...
                 <td>
                    <?php if($ans['student_id']): ?>
                        ...
                        <a href="softwaresendcode.php?id=<?php echo $ans['id'] ?> &stid=<?php echo $stid ?> " class="btn btn-warning">Code Receive <i class="fa-solid fa-thumbs-up"></i> </i></a>
                   
                    <?php else: ?>

                        <a href="softwaresendcode.php?id=<?php echo $ans['id'] ?> &stid=0 " class="btn btn-info"> Send Code <i class="fa-regular fa-message"></i> </i></a>
