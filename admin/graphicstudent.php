               ...
               ?>
                 ...
                 <td>
                    <?php if($ans['student_id']): ?>
                        ...
                        <a href="graphicsendcode.php?id=<?php echo $ans['id'] ?> &stid=<?php echo $stid ?> " class="btn btn-warning">Code Receive <i class="fa-solid fa-thumbs-up"></i> </i></a>
                   
                    <?php else: ?>

                        <a href="graphicsendcode.php?id=<?php echo $ans['id'] ?> &stid=0 " class="btn btn-info"> Send Code <i class="fa-regular fa-message"></i> </i></a>
